...
import { Table, Card, Button,UncontrolledDropdown,Nav,  NavItem, Badge,Col,NavLink, Row,DropdownMenu, DropdownToggle} from 'reactstrap';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import selectors  from '../../Selectors/SchoolSelector'
import Select from 'react-select';
import { ArrowDownRight, ArrowUpRight, Filter, ArrowDownCircle, ArrowUpCircle, Circle } from 'react-feather';
...
const select = ({ School }) => ({
    loading: selectLoading(School),
    trips: School ? School.schools : null,
  });
export default connect(select)(SchoolPage);